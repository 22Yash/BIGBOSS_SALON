...
function Hero() {
  ...
  return (
    <>
    <div id="Hero" className='merriweather-regular w-full h-screen sm:w-full sm:h-screen lg:w-full lg:h-screen ' style={{backgroundImage:`url(${image1})`, objectFit:'cover'}  } >
        <Navbar/>
