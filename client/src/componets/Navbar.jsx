...
function Navbar() {
  ...
  return (
    <>
      <div id="navBar" className="merriweather-regular flex justify-between h-[60px] lg:flex lg:justify-between bg-white lg:h-[120px] lg:p-[10px] ">
        <div id="leftNav" className="lg:p-[20px] p-[20px] ">
          <a href="/"><img src={salonLogo} alt="" className="lg:w-[150px] lg:ml-[30px]"/></a>
          
        </div>
        <div id="rightNav" className="lg:pt-[30px]">
